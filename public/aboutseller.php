<?php
    ...
    "<tr><td><img alt='thumbnail' src='".$row['image']."'/></td><td>".$row['title']."</td><td>".$row['price']."</td><td>".$row['Description']."</td><td>".$row['category']."</td><td>".$row['date']."</td><td>".$row['contact']."</td></tr>";
    echo "<a href='aboutseller.php?user=".$row."'>View More From This Seller</a>";
    }
    if(!empty($_GET['user'])){
