<form action="sell.php" method="POST">
    <fieldset>
        ...
        Title:<input type="text" required autofocus placeholder="Eg:Watch Min. length(4chars)" minlength="4"/><br/>
        Description:<input type="text" required placeholder="Details Maxlength(200 chars)" maxlength="200" name="desciption"/><br/>
